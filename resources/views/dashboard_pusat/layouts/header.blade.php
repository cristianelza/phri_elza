                    ...
                    <div class="menu-state-bg menu-extended overflow-hidden overflow-lg-visible" data-kt-menu-dismiss="true">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8 mb-3 mb-lg-0 py-3 px-3 py-lg-6 px-lg-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 mb-3">
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="asset{{ 'demo1/dashboards/projects.html' }}" class="menu-link">
                                                <span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                    ...
                                    <div class="col-lg-6 mb-3">
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="asset{{ 'demo1/dashboards/online-courses.html' }}" class="menu-link">
                                                <span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                    ...
                                    <div class="col-lg-6 mb-3">
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="asset{{ 'demo1/dashboards/marketing.html' }}" class="menu-link">
                                                <span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                    ...
                                    <div class="col-lg-6 mb-3">
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="asset{{ 'demo1/dashboards/bidding.html' }}" class="menu-link">
                                                <span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                    ...
                                    <div class="col-lg-6 mb-3">
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="asset{{ 'demo1/dashboards/pos.html' }}" class="menu-link">
                                                <span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                    ...
                                    <div class="col-lg-6 mb-3">
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="asset{{ 'demo1/dashboards/call-center.html' }}" class="menu-link">
                                                <span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                            ...
                            <div class="menu-more bg-light col-lg-4 py-3 px-3 py-lg-6 px-lg-6 rounded-end">
                                ...
                                <div class="menu-item p-0 m-0">
                                    <!--begin:Menu link-->
                                    <a href="asset{{ 'demo1/dashboards/logistics.html' }}" class="menu-link py-2">
                                ...
                                <div class="menu-item p-0 m-0">
                                    <!--begin:Menu link-->
                                    <a href="asset{{ 'demo1/dashboards/website-analytics.html' }}" class="menu-link py-2">
                                ...
                                <div class="menu-item p-0 m-0">
                                    <!--begin:Menu link-->
                                    <a href="asset{{ 'demo1/dashboards/finance-performance.html' }}" class="menu-link py-2 active">
                                ...
                                <div class="menu-item p-0 m-0">
                                    <!--begin:Menu link-->
                                    <a href="asset{{ 'demo1/dashboards/store-analytics.html' }}" class="menu-link py-2">
                                ...
                                <div class="menu-item p-0 m-0">
                                    <!--begin:Menu link-->
                                    <a href="asset{{ 'demo1/dashboards/social.html' }}" class="menu-link py-2">
                                ...
                                <div class="menu-item p-0 m-0">
                                    <!--begin:Menu link-->
                                    <a href="asset{{ 'demo1/dashboards/delivery.html' }}" class="menu-link py-2">
                                ...
                                <div class="menu-item p-0 m-0">
                                    <!--begin:Menu link-->
                                    <a href="asset{{ 'demo1/dashboards/crypto.html' }}" class="menu-link py-2">
                                ...
                                <div class="menu-item p-0 m-0">
                                    <!--begin:Menu link-->
                                    <a href="asset{{ 'demo1/dashboards/school.html' }}" class="menu-link py-2">
                                ...
                                <div class="menu-item p-0 m-0">
                                    <!--begin:Menu link-->
                                    <a href="asset{{ 'demo1/dashboards/podcast.html' }}" class="menu-link py-2">
